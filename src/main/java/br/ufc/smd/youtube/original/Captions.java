package br.ufc.smd.youtube.original;
 ...
 *
 * 1. Uploading a caption track for a video via "captions.insert" method. 2.
 * Getting the caption tracks for a video via "captions.list" method. 3.
 * Updating an existing caption track via "captions.update" method. 4. Download
 * a caption track via "captions.download" method. 5. Deleting an existing
 * caption track via "captions.delete" method.
 *
...
public class Captions {
	...
	/**
	 * Define a global variable that specifies the MIME type of the caption being
	 * uploaded.
	 */
	 ...
	 */
	private static final String SRT = "txt";
	 ...
	 *                  that is being deleted. In a caption resource, the id
	...
	private static void downloadCaption(String captionId) throws IOException {
		...
		Download captionDownload = youtube.captions().download(captionId);
	 ...
	 *
	 * @param captionId   The id parameter specifies the caption ID for the resource
	 *                    that is being updated. In a caption resource, the id
	 *                    property specifies the caption track's ID.
	 ...
	 *
	 * @param videoId The videoId parameter instructs the API to return the caption
	 ...
	 *
	 * @param videoId         the YouTube video ID of the video for which the API
	...
	/*
	 * Prompt the user to enter a language for the caption track. Then return the
	 * language.
	 */
