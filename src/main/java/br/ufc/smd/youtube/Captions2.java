...
public class Captions2 {
	...
	/**
	 * Define a global variable that specifies the MIME type of the caption being uploaded.
	 */
	...
	public static void executaAcaoParaCaptions() {
		try {
			...
			default:
				...
				// Prompt the user to specify a video to upload the caption track for and a language, a name, a binary file for the caption track. 
				// Then upload the caption track with the values that are selected by the user.
	 ...
	 *
	 * @param captionId The id parameter specifies the caption ID for the resource that is being downloaded. 
	...
	private static void downloadCaption(String captionId) throws IOException {
		...
		// Indicate whether direct media download is enabled. 
		// A value of "True" indicates that direct media download is enabled and that the entire media content will be downloaded in a single request.
		// A value of "False," which is the default, indicates that the request will use the resumable media download protocol, 
		// which supports the ability to resume a download operation after a network interruption or other transmission failure, 
		...
		MediaHttpDownloaderProgressListener downloadProgressListener = new MediaHttpDownloaderProgressListener() {
			public void progressChanged(MediaHttpDownloader downloader) throws IOException {
				...
				case MEDIA_IN_PROGRESS:
					...
					break;
				// This value is set after the entire media file has been successfully downloaded.
				case MEDIA_COMPLETE:
					System.out.println("Download Completed!");
					break;
				// This value indicates that the download process has not started yet.
				case NOT_STARTED:
	 ...
	 *
	 * @param captionId The id parameter specifies the caption ID for the resource that is being deleted. 
	 * 					In a caption resource, the id property specifies the caption track's ID.
	 * @throws IOException
	 */
	private static void deleteCaption(String captionId) throws IOException {
		// Call the YouTube Data API's captions.delete method to delete an existing caption track.
		youtube.captions().delete(captionId);
		System.out.println("  -  Deleted caption: " + captionId);
	}

	/**
	 * Updates a caption track's draft status to publish it. Updates the track with
	 * a new binary file as well if it is present. (captions.update)
	 *
	 * @param captionId The id parameter specifies the caption ID for the resource that is being updated. 
	 * 					In a caption resource, the id property specifies the caption track's ID.
	...
	private static void updateCaption(String captionId, File captionFile) throws IOException {
		...
		if (captionFile == null) {
			...
			InputStreamContent mediaContent = new InputStreamContent(CAPTION_FILE_FORMAT,
			...
			// Indicate whether direct media upload is enabled. 
			// A value of "True" indicates that direct media upload is enabled and that the entire media content will be uploaded in a single request.
			// A value of "False," which is the default, indicates that the request will use the resumable media upload protocol, 
			// which supports the ability to resume an upload operation after a network interruption or other transmission failure, 
			// saving time and bandwidth in the event of network failures.
			...
			MediaHttpUploaderProgressListener progressListener = new MediaHttpUploaderProgressListener() {
				public void progressChanged(MediaHttpUploader uploader) throws IOException {
					...
					// This value is set before the initiation request is sent.
					case INITIATION_STARTED:
						System.out.println("Initiation Started");
						break;
					// This value is set after the initiation request completes.
					case INITIATION_COMPLETE:
						System.out.println("Initiation Completed");
						break;
					// This value is set after a media file chunk is uploaded.
					case MEDIA_IN_PROGRESS:
						System.out.println("Upload in progress");
						System.out.println("Upload percentage: " + uploader.getProgress());
						break;
					// This value is set after the entire media file has been successfully uploaded.
					case MEDIA_COMPLETE:
						System.out.println("Upload Completed!");
						break;
					// This value indicates that the upload process has not started yet.
					case NOT_STARTED:
	...
	/**
	 * Uploads a caption track in draft status that matches the API request parameters. (captions.insert)
	 *
	 * @param videoId         the YouTube video ID of the video for which the API should return caption tracks.
